use crate::back::sieve_ir_v3::field::encode_scalar;
use crate::back::sieve_ir_v3::field::get_field_order;
use crate::back::sieve_ir_v3::ir_dedup::IRDedup;
use crate::back::sieve_ir_v3::ir_profiler::IRProfiler;
use ff::PrimeField;
use num_bigint::{BigUint, BigInt};
use num_integer::Integer;
use num_traits::{Zero, One};
use zki_sieve_v5::{WireId, Value, Sink};
use zki_sieve_v5::producers::builder::{BuildGate, GateBuilder, GateBuilderT};
...
use std::ptr::NonNull;
use std::rc::Rc;
use zki_sieve_v5::producers::build_gates::NO_OUTPUT;
