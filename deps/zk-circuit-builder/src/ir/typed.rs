...
tuple_impl!(A1 B1, A2 B2, A3 B3, A4 B4, A5 B5, A6 B6, A7 B7, A8 B8, A9 B9, A10 B10, A11 B11);
tuple_impl!(A1 B1, A2 B2, A3 B3, A4 B4, A5 B5, A6 B6, A7 B7, A8 B8, A9 B9, A10 B10, A11 B11, A12 B12);
...
impl<'a, A: FromWireList<'a>> FromWireList<'a> for Vec<A> {
    fn expected_num_wires(sizes: &mut impl Iterator<Item = usize>) -> usize {
